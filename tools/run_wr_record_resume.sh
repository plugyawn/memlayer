...
echo "wr_record_resume_checkpoint checkpoint=${WR_RESUME_CHECKPOINT:-<none>} load_adam=${WR_RESUME_LOAD_ADAM:-0} restore_rng=${WR_RESUME_RESTORE_RNG:-1} advance_data=${WR_RESUME_ADVANCE_DATA:-1}"
