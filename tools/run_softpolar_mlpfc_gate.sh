...
log_path="${LOG_PATH:-.opencode/softpolar_mlpfc_layers${label_layers}_win${label_windows}_a${label_alpha}_eps${label_eps}_screen${steps}.log}"
...
LOCO_SOFT_POLAR=1 \
LOCO_SOFT_POLAR_SURFACES="${LOCO_SOFT_POLAR_SURFACES:-mlp_fc}" \
