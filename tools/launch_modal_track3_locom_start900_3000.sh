...
run_name="${MODAL_RUN_NAME:-track3-simple-locom-3000-start900-h100-r1-20260601}"
...
extra = {
    ...
    "TRACK3_LOCOM_START_STEP": "900",
    "TRACK3_LOCOM_END_STEP": "3000",
    "TRACK3_LOCOM_INTERVAL": "1",
    "TRACK3_LOCOM_LOG_STEPS": "0,1,2,10,50,125,250,500,750,875,900,901,1000,1125,1250,1500,1750,2000,2250,2500,2750,3000",
}
